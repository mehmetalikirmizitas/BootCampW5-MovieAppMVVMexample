...
class MovieAdapter(private val movieList: List<Result>) : RecyclerView.Adapter<MovieViewHolder>() {
...
class MovieViewHolder(private val binding: MovieRecyclerViewItemBinding) :
